...
class CreateSubKegiatanAction extends SubKegiatanAction
{
    private $rule = [
        'satuanId' => 'required',
        'kegiatanId' => 'required',
    ...
    protected function action(): Response
    {
        ...
        if (!in_array('C_SUB_KEGIATAN', $permission)) {
        ...
        try {
            ...
            $insertService = $this->subKegiatanRepository->create($putDataSubKegiatan);
            return $this->respondWithData(data: $insertService, message: "Berhasil menambah sub kegiatan", statusCode: 201);
        } catch (Exception $e) {
