...
class CreateRincianObjekRekeningAction extends RincianObjekRekeningAction
{
    private $rule = [
    ...
    protected function action(): Response
    {
        ...
        if (!in_array('C_RINCIAN_OBJEK_REKENING', $permission)) {
        ...
        try {
            ...
            $insertService = $this->rincianObjekRekeningRepository->create($putDataRincianObjekRekening);
            return $this->respondWithData(data: $insertService, message: "Berhasil menambah rincian objek rekening", statusCode: 201);
        } catch (Exception $e) {
