...
class DeletePermissionRoleAction extends RoleAction
{
    private $rule = [
    ...
    protected function action(): Response
    {
        ...
        if (!in_array('D_ROLE_PERMISSION', $permission)) {
        ...
        try {
            ...
            $rolePermission = $this->roleRepository->deleteRolePermission((int)$this->args['id'], (int)$body['permission.id']);
