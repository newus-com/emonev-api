...
class AddPermissionUserAction extends UserAction
{
    private $rule = [
    ...
    protected function action(): Response
    {
        ...
        if(!in_array('C_USER_SPECIAL_PERMISSION', $permission)) {
        ...
        try {
            ...
            $userPermission = $this->userRepository->addSpecialPermissionUser((int)$this->args['id'], (int)$body['permission.id']);
