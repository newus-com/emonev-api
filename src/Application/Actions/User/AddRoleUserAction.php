...
class AddRoleUserAction extends UserAction
{
    private $rule = [
        'role.id' => 'required',
    ];
    ...
    protected function action(): Response
    {
        ...
        if(!in_array('C_USER_ROLE', $permission)) {
        ...
        try {
            ...
            $userRole = $this->userRepository->addUserRole((int)$this->args['id'], (int)$body['role.id']);
