...
class CreateWilayahAction extends WilayahAction
{
    private $rule = [
        'wilayah' => 'required',
    ];
    ...
    protected function action(): Response
    {
        ...
        if (!in_array('C_WILAYAH', $permission)) {
        ...
        try {
            ...
            $insertService = $this->wilayahRepository->create($putDataWilayah);
            return $this->respondWithData(data: $insertService, message: "Berhasil menambah wilayah", statusCode: 201);
        } catch (Exception $e) {
